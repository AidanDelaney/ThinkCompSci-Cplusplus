...
% Use non-culry double quotes -- particularly for source listings
\renewcommand{\textquotedbl}{\textquotesingle\textquotesingle}
\lstset{language=C++,upquote=true,literate={"}{\textquotedbl}1}
\pssilent
...
Copyright (C) 1999  Allen B. Downey\\
updates (C) 2010--2014 Narendra Sisodiya, Tirtha P. Chatterjee and Aidan Delaney\footnote{\href{mailto:aidan@ontologyengineering.org}{aidan@ontologyengineering.org}}
\end{center}
\vspace{0.25in}
